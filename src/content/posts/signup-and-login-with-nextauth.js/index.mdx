...
summary: This article describes how to set up NextAuth.js and authenticate against
  your own backend.
imageId: /ekrresa-app/login-signup-next-auth.jpg
imageAlt: Black and grey keys on a door
imageCredit: Photo by [George Becker] (https://www.pexels.com/photo/black-and-grey-keys-792034)
published: true
---
