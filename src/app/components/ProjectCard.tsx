      ...
      >
        <div className="min-w-0">
          ...
          >
            <h3
              className="
                font-display text-3xl leading-none tracking-[-0.04em] text-ink transition-colors
            ...
            <span
              className="
                inline-flex w-fit items-center gap-1.5 rounded-full border border-black/8 px-3 py-1
                text-[0.65rem] font-medium tracking-[0.24em] text-muted/80 uppercase
